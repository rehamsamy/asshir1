...
class AppTheme {
  AppTheme._();
  static Color primaryColor = Color(0xff3A6298);
  static Color darkPrimaryColor = Color(0xffEC2991);
  static Color accentColor = Color(0xffE9098D);
  static Color primaryTextColor=Color(0xffB7457B);
  ...
  static TextStyle basicPrimaryStyle = TextStyle(
      fontFamily: fontName,
      fontWeight: FontWeight.bold,
      fontSize: 16,
      letterSpacing: 0.27,
  ...
  static const TextStyle baseTextColor = TextStyle(
    fontFamily: fontName,
    fontWeight: FontWeight.bold,
    fontSize: 16,
    letterSpacing: 0.27,
    color: Colors.black
    //color: Color(0xffB7457B),
  );
